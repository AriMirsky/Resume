...
\resumeItem{Researched and designed supervised machine learning algorithm using a random forest approach for determining how densly to sample the state space}
